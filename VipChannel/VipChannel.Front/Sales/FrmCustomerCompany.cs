...
{
    public partial class FrmCustomerCompany : Form
    {
        ...
        public FrmCustomerCompany(int operation, Guid id)
        {
            InitializeComponent();
            _operation = operation;
            _id = id;
            _personType = ConstantPersonType.Juridica;
        }
        ...
        private void FrmPlanCable_Load(object sender, EventArgs e)
        {
            ...
            if (_operation == Convert.ToInt32(Operation.Create))
            {
                ...
                lblTituloFormulario.Text = Constants.FormCreateNames.FrmCustomerCompanyCreate;
            }
            else if (_operation == (int)Operation.Update)
            {
                lblTituloFormulario.Text = Constants.FormCreateNames.FrmCustomerCompanyUpdate;
                _customerApplication = new CustomerApplication();
