...
namespace VipChannel.Domain.Entity
{
    ...
    public partial class Plan
    {
        ...
        public Nullable<decimal> InternetUpload { get; set; }
        public string UploadInternetSpeedType { get; set; }
        public Nullable<decimal> InternetDownload { get; set; }
        public string DownloadInternetSpeedType { get; set; }
